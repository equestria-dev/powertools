...
exports.deleteEverythingRecurive = exports.isFileTheSame = exports.stat = exports.getFileHash = exports.getFile = exports.manyPrints = exports.ls = void 0;
// https://github.com/scientifichackers/ampy/blob/master/ampy/files.py#L88
const ls = (args = { directory: "/", recursive: false, includeSha256: false }) => {
...
exports.stat = stat;
const isFileTheSame = (filename, fileSize, sha256Hash) => {
    return `
try:
    import os
except ImportError:
...
exports.isFileTheSame = isFileTheSame;
const deleteEverythingRecurive = (path) => {
    return `
try:
    import os
except ImportError:
...
exports.deleteEverythingRecurive = deleteEverythingRecurive;
//# sourceMappingURL=python-scripts.js.map